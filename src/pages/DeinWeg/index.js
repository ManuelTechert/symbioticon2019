...
import {CardTitle, Container, Title, Card, Smaller} from "../../components/globals";
        ...
        <Container>
            ...
            <Card style={{backgroundColor: "#067AE4", color: 'white'}}>
                <Row>
                    <Item flex={3}>
                        <CardTitle>
                            Wasser trinken (empfohlen)
                        </CardTitle>
                        <Smaller>
                            Trinke gleich nach dem Aufstehen ein Glas Wasser, um Deinen Körper in Schwung zu bringen
                        </Smaller>
                    </Item>
                    <Item>
            ...
            <Card>
                <Row>
                    <Item flex={3}>
                        <CardTitle>
                            Verbinde weitere Services
                        </CardTitle>
                        <Smaller>
                            Je mehr Services und Dienste du verbindest, desto mehr Insights können wir dir liefern.
                        </Smaller>
                    </Item>
                    <Item>
