...
const Footer = () => {
  ...
  const styleFunction = path => ({
    color: path === history.location.pathname ? '#FF5A5F' : '#5C6166',
  })
  ...
  return (
    <Container>
      <ColContainer>
        ...
        <Col
          onClick={() => history.push(`/deinweg`)}
          style={styleFunction('/deinweg')}
        >
          <Map height="50px" />
          <Subtitel>Dein Weg</Subtitel>
        </Col>
        <Col
          onClick={() => history.push(`/thrive`)}
          style={styleFunction('/thrive')}
        >
          <Compass height="50px" />
